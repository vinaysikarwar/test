...
class WTC_Enquiry_Block_Adminhtml_Enquiry_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  public function __construct()
  {
      ...
      $this->setDestElementId('enquiry_form');
      $this->setTitle(Mage::helper('enquiry')->__('Item Information'));
  }

  protected function _beforeToHtml()
  {
      $this->addTab('form_section', array(
          'label'     => Mage::helper('enquiry')->__('Item Information'),
          'title'     => Mage::helper('enquiry')->__('Item Information'),
